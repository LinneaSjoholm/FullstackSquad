  ...
  return (
    <div className="about-container">
      ...
      <main className="about-content">
        ...
        <section className="about-team-section">
          ...
          <div className="about-team-members">
            ...
            <div className="about-team-card">
              <img src="../images/Emma.jpg" alt="Emma" className="about-team-photo" />
            ...
            {/* Linnea */}
            <div className="about-team-card">
              <img src="../images/Linnea.jpg" alt="Linnea" className="about-team-photo" />
              <p className="about-team-description">
            ...
            {/* Lam */}
            <div className="about-team-card">
              <img src="../images/Lam.jpg" alt="Lam" className="about-team-photo" />
              <p className="about-team-description">
            ...
            {/* Victoria */}
            <div className="about-team-card">
              <img src="../images/Victoria.jpg" alt="Victoria" className="about-team-photo" />
              <p className="about-team-description">
        ...
        <section className="about-meet-the-team-section">
          <h3>Meet the Team Behind Gusto To Go</h3>
          <p>
